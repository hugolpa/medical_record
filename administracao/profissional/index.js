...
import { Input, Button, Card, Form, Modal, Select, Checkbox, List, Typography, Avatar, Table,Tooltip } from 'antd'
import { FilterOutlined, HomeOutlined, UserOutlined, LockOutlined, MenuOutlined, SearchOutlined, CloseOutlined } from '@ant-design/icons'
...
const Profissional = () => {
  ...
  const dataSource = [
    {
      ...
      icone1: <div><HomeOutlined className="mr-2"  /><LockOutlined className="mr-2" /><UserOutlined className="mr-2" /><Tooltip title="vizualizar, editar, excluir"><MenuOutlined /></Tooltip></div>
  ...
  const dataSource2 = [
    {
      ...
      fim: '29/10/2021',
      motivo: 'Curso',
      icone1: <SearchOutlined className="ml-2 mr-2" />,
      icone2: <CloseOutlined className="ml-2 mr-2" />,
      icone3: <Button type="primary" htmlType="submit" className="text-center w-20"><strong>Adicionar</strong></Button>,
  ...
  return (
    <div>
      ...
      <Button type="secundary" htmlType="submit" className="text-center w-20">
        <strong>Voltar</strong>
      </Button>
